        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-100">
                    ...
                    {{-- card dalam --}}
                    <div class="bg-gray-600 rounded-lg max-w-6xl py-3 px-3">
                        <h1 class="text-lg font-medium ms-3">Statistik</h1>
                        {{-- statistik --}}
                        <div class="flex justify-between mx-12">
                            {{-- anggota --}}
                            <div class="bg-gray-700 rounded-lg max-w-2xl w-56 py-3 my-3 ms-4">
                                ...
                                <div class="flex justify-center my-3">
                                    ...
                                    <p class="text-white-font-medium text-lg mx-3">80</p>
                                    <p class="text-white-font-medium text-lg">Anggota</p>
                                </div>
                            </div>
                            {{-- akhir anggota --}}
                            {{-- latihan --}}
                            <div class="bg-gray-700 rounded-lg max-w-2xl w-56 py-3 my-3 ms-4">
                                ...
                                <div class="flex justify-center my-3">
                                    ...
                                    <p class="text-white-font-medium text-lg mx-3">80</p>
                                    <p class="text-white-font-medium text-lg">Pelatihan</p>
                                </div>
                            </div>
                            {{-- akhir latihan --}}
                            {{-- menuwo --}}
                            <div class="bg-gray-700 rounded-lg max-w-2xl w-56 py-3 my-3 ms-4">
                                ...
                                <div class="flex justify-center my-3">
                                    ...
                                    <p class="text-white-font-medium text-lg mx-3">24</p>
                                    <p class="text-white-font-medium text-lg">Wo Menu</p>
                                </div>
                            </div>
                            {{-- akhir menuwo --}}
                        </div>
                    ...
                    {{-- akhir card dalam --}}
                    {{-- card dalam motivasi --}}
                    <div class="bg-gray-600 rounded-lg max-w-6xl py-3 px-3 my-5">
