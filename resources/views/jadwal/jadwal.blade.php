    ...
    <div class="grid grid-cols-12 gap-4 px-10 py-5">
        ...
        <div class="col-span-9 ">
            <div class="container dark:bg-gray-700 h-full bg-white rounded-lg shadow-md p-5">
                <h1 class="text-2xl font-bold text-black dark:text-white">Kalender Mingguan</h1>
                ...
                <div class="grid grid-cols-7 gap-4">
                    @foreach ($weekDays as $day)
                        <div
                            class="p-4 rounded-lg border border-gray-200 dark:border-blue-800 dark:bg-blue-800 dark:hover:bg-blue-900 text-white mb-3">
                            <h2
                                class="text-lg text-center font-bold mb-2 {{ $day['isActive'] ? 'text-blue-300' : 'text-gray-100' }}">
                                {{ $day['day'] }}
                            </h2>
                            <h2
                                class="text-lg text-center font-bold mb-2 {{ $day['isActive'] ? 'text-blue-300' : 'text-gray-100' }}">
                            ...
                            @foreach ($day['notes'] as $note)
                                <div
                                    class="flex flex-wrap justify-start bg-gray-600 rounded-lg shadow-lg py-2 px-2 mb-2">
                                    <p class="text-black dark:text-white">{{ $note->note }} {{ $note->waktu }}</p>
